...
var SPREADSHEET_URL = 'https://docs.google.com/spreadsheets/d/1BddE4yRbhNiKFYjHA3zTHdDU4RBDWmTLoO7BQwZBrWI/edit?usp=sharing';
...
var selectedAccounts=[  "330-538-0835",
                        "140-523-3363",
                        "553-745-3356",
                        "166-509-7683",
                        "907-063-5935",
...
function processAccount(account, spreadsheet, startingRow) {
  ...
  var dataRows = [[
    account.getName() , todayStats.Impressions, todayStats.Clicks,
...
var mccManager = (function() {
  ...
  var init = function() {
    ...
    for(let i =0;i<selectedAccounts.length;i++){
        if(selectedAccounts[i].value() === AdsManagerApp.account.getCustomerId() )
        accountSelector += AdsManagerApp.account();
    }
